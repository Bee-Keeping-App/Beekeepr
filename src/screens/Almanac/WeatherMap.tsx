...
// Hard-coded coordinates for Troy, NY
...
// HTML string for Leaflet radar map
...
export function WeatherMap() {
  ...
  React.useEffect(() => {
    const fetchForecast = async () => {
      try {
        const url =
          `https://api.open-meteo.com/v1/forecast?latitude=${TROY_LAT}&longitude=${TROY_LON}&daily=temperature_2m_max,temperature_2m_min,weathercode&temperature_unit=fahrenheit&timezone=auto`.replace(
            /\s+/g,
            ""
          );
